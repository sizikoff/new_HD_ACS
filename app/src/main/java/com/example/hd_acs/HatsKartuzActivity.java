...
public class HatsKartuzActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hats_kartuz);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnPanama:
                Intent actP = new Intent(HatsKartuzActivity.this, HatsPanamaActivity.class);
                startActivity(actP);
                finish();
                break;
            case R.id.imgBtnHome:
                Intent actHome = new Intent(HatsKartuzActivity.this, MainActivity2.class);

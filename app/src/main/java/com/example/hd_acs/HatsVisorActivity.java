...
public class HatsVisorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hats_visor);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnPanama:
                Intent actP = new Intent(HatsVisorActivity.this, HatsPanamaActivity.class);
                startActivity(actP);
                finish();
                break;
            case R.id.imgBtnHome:
                Intent actHome = new Intent(HatsVisorActivity.this, MainActivity2.class);
